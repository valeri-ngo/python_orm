...
class Restaurant(models.Model):
    ...
    rating = models.DecimalField(
        ...
        decimal_places=2,
        validators=[
            MinValueValidator(Decimal('0.00'), message='Rating must be at least 0.00.'),
            MaxValueValidator(Decimal('5.00'), message='Rating cannot exceed 5.00.'),
        ]
    )
